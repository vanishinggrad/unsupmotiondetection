...
def do_kmeans(x_train, y_train, x_test, y_test, num_reps = 30):

    test_accs = []
    for _ in range(num_reps):
    
        kmeans = KMeans(n_clusters=2, n_init=10).fit(x_train)
...
if __name__ == "__main__":
    ...
    print("lab:")
    lab = do_kmeans(x_train, y_train, x_test, y_test)
    ...
    print("house:")
    house = do_kmeans(x_train, y_train, x_test, y_test)
